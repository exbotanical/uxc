...
export type ResolversTypes = {
	...
	CommunityThread: ResolverTypeWrapper<
		Omit<CommunityThread, 'users'> & {
...
export type ResolversParentTypes = {
	...
	CommunityThread: Omit<CommunityThread, 'users'> & {
...
export type CommunityThreadResolvers<
	ContextType = Context,
	ParentType extends ResolversParentTypes['CommunityThread'] = ResolversParentTypes['CommunityThread']
> = {
...
> = {
	...
	createThread?: Resolver<
		...
		ParentType,
		ContextType,
		RequireFields<MutationCreateThreadArgs, never>
	>;
	...
	join?: Resolver<
		...
		ParentType,
		ContextType,
		RequireFields<MutationJoinArgs, never>
	>;
	signin?: Resolver<
		Maybe<ResolversTypes['User']>,
		ParentType,
...
> = {
	...
	getMessages?: Resolver<
		...
		ParentType,
		ContextType,
		RequireFields<QueryGetMessagesArgs, never>
	>;
	getThread?: Resolver<
		Maybe<ResolversTypes['PrivateThread']>,
		ParentType,
		ContextType,
		RequireFields<QueryGetThreadArgs, never>
	>;
	getThreads?: Resolver<
		Maybe<Array<Maybe<ResolversTypes['PrivateThread']>>>,
		ParentType,
		ContextType,
		RequireFields<QueryGetThreadsArgs, never>
	>;
	getUser?: Resolver<
		Maybe<ResolversTypes['User']>,
		ParentType,
...
> = {
	onMessage?: SubscriptionResolver<
		Maybe<Array<Maybe<ResolversTypes['Message']>>>,
		'onMessage',
		ParentType,
		ContextType,
		RequireFields<SubscriptionOnMessageArgs, never>
	>;
	onThread?: SubscriptionResolver<
		Maybe<Array<Maybe<ResolversTypes['PrivateThread']>>>,
		'onThread',
		ParentType,
		ContextType
